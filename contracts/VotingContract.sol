...
contract Create {
    ...
    struct Candidate { 
        ...
        function getCandidatetength() public view returns (uint256) {
        ...
        function voterRight( 
            ...
            require (
                votingOrganizer == msg.sender, 
                "Only orgainzer can create voter not you" 
            ); 
        ...
        function getVotertength() public view returns (uint256){ return votersAddress.length; 
        } 
